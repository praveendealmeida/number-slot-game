...
//
// Verifies an OTP against our server-side stored hash (Notify.lk has no
// verify endpoint — it only delivers the SMS). On success, finds or creates
// the user by phone, ensures a wallet, and issues a mobile session JWT.
// ---------------------------------------------------------------------------
...
export async function POST(request: Request) {
  ...
  // Verify the OTP against our stored hash
  ...
  // Ensure wallet exists (with demo balance in demo mode)
